...
export class MainComponent implements OnInit{
  ...
  comunity: any = [
    ...
    { SIGLA: 'T', DESCRICAO: 'TRANSEXUAIS são pessoas que não se identificam com o gênero atribuído em seu nascimento, isto é, a transexualidade se refere à identidade de gênero oposta ao sexo físico biológico, utilizado tanto para identidades masculinas (transmasculino), quanto femininas (transfeminina). TRAVESTIS são pessoas que nasceram com determinado sexo, atribuído culturalmente ao gênero considerado correspondente pela sociedade, mas que passa a se identificar e construir nela mesma o gênero oposto.', TITULO: 'TRANSEXUAIS e TRAVESTIS' },
